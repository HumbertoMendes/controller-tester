<template>
  <div>
    <div>
      <div class="game-controller__extra-group">
        <div>
          <div
            class="game-controller__trigger game-controller__button"
            :style="`background-color: ${getFill(key.L2)}`"
          />
          <div
            class="game-controller__trigger game-controller__button"
        ...
        <div>
          <div
            class="game-controller__trigger game-controller__button"
            :style="`background-color: ${getFill(key.R2)}`"
          />
          <div
            class="game-controller__trigger game-controller__button"
            :style="`background-color: ${getFill(key.R1)}`"
          />
        </div>
      </div>
    </div>
    ...
    >
      ...
      >
        <sodipodi:namedview
          ...
          inkscape:cx="-219.15878"
          inkscape:cy="-651.91507"
          fit-margin-right="0"
          fit-margin-bottom="0"
        ...
        >
          ...
          >
            ...
            <path
              ...
              style="stroke:#000000;stroke-width:3;"
              :style="`fill:${getFill(key.B2)};`"
              inkscape:connector-curvature="0"
            />
            <path
              id="path3322"
              style="stroke:#000000;stroke-width:3;"
              :style="`fill:${getFill(key.RIGHT)};`"
              inkscape:connector-curvature="0"
      ...
      <div
        class="game-controller__center game-controller__button"
        :style="`background-color: ${getFill(key.CENTER)}`"
      />
    </div>
  </div>
</template>
...
<script>
import * as Key from '../constants/KeysConstants';
...
export default {
  ...
  methods: {
    ...
    getFill(id) {
      console.log(id);
      return this.isButtonActive(id) ? 'red' : 'transparent';
    },
  },
};
</script>
